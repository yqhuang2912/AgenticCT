...
from utils.image_save_load import load_image  # 如果暂时用不到可以删掉
...
def main():
    parser = argparse.ArgumentParser(description="LDCT Training with SwanLab")
    parser.add_argument(
        "--train_dataset_info_file",
        type=str,
        default="/data/hyq/codes/AgenticCT/data/deeplesion/ldct/train_dataset_info.csv",
        help="Path to the train dataset info file",
    )
    parser.add_argument(
        "--val_dataset_info_file",
        type=str,
        default="/data/hyq/codes/AgenticCT/data/deeplesion/ldct/val_dataset_info.csv",
    ...
    parser.add_argument(
        "--save_dir_root",
        type=str,
        default="/data/hyq/codes/AgenticCT/src/pretrain/outputs/deeplesion/ldct",
